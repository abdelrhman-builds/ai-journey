...
# =============================================
# SECTION 2: RAG Setup Tool (Loads a Document)
# =============================================

@tool
def load_document(text: str, source_name: str = "uploaded_document") -> str:
    """
    Load a text document into the RAG system for future questions.
    Call this FIRST before asking questions about a specific document.
    The text parameter should contain the full document content.
    """
    global vectorstore
    ...
    # Embed and store (Day 16 logic)
    vectorstore = Chroma.from_documents(
        documents=chunks,
        embedding=embeddings_model
    )

    return f"Document '{source_name}' loaded successfully. {len(chunks)} chunks created and ready for questions."
...
tools = [load_document, search_document, web_search]
